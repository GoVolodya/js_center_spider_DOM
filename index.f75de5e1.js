...
const wallBorderX = parseInt(wallStyles.borderLeftWidth) + parseInt(wallStyles.borderRightWidth);
const wallBorderY = parseInt(wallStyles.borderTopWidth) + parseInt(wallStyles.borderBottomWidth);
